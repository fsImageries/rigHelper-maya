...
def get_mayaPref(mayaPref_path=None, mayaVer=None):
    ...
    if mayaPref_path is None or not os.path.isdir(mayaPref_path):
        ...
        if OS_NAME == "darwin":   # -check if macOSX is running
            ...
            raise OSError("{0} not supported yet.\nPlease copy the rigHelper.py into your plug-ins folder.")
...
def main():
    try:
        ...
        print("Couldn't install rigHelper package.")
        raise
    # else:
    #     # -copy rigHelper.py to plugin_path
